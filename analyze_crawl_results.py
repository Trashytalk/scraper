                ...
                try:
                    ...
                    if isinstance(result_data, dict):
                        ...
                        if 'summary' in result_data:
                            ...
                            if crawled_data:
                                print(f"      First page URL: {crawled_data[0].get('url', 'N/A')}")
                                if len(crawled_data) > 1:
                                    print(f"      Second page URL: {crawled_data[1].get('url', 'N/A')}")
                                    print(f"      Last page URL: {crawled_data[-1].get('url', 'N/A')}")
                        else:
                            # Single page result
                            print(f"      Single page result for: {result_data.get('url', 'N/A')}")
            ...
            for job in thailand_jobs:
                ...
                if result:
                    try:
                        ...
                        if isinstance(result_data, dict) and 'crawled_data' in result_data:
                            ...
                            print(f"      Title: {result_data.get('title', 'N/A')[:50]}")
                            links = result_data.get('links', [])
                            print(f"      Links found: {len(links)}")
