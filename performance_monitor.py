...
class PerformanceMetrics:
    ...
    def get_system_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            recent_errors = sum(1 for req in self.request_times 
...
class DatabaseOptimizer:
    ...
    def execute_optimized_query(self, query: str, params: tuple = (), fetch: str = "none") -> Any:
    ...
    while True:
        try:
            ...
            if metrics['errors_per_minute'] > 10:
                logger.warning(f"High error rate: {metrics['errors_per_minute']} errors/minute")
