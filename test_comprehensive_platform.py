...
from business_intel_scraper.backend.utils.security import (
    ...
    InputValidator, SecurityEvent, ThreatType, SecurityLevel
)
...
from business_intel_scraper.backend.utils.compliance import (
    ...
    DataSubject, ConsentRecord, DataCategory, ConsentType
)
...
class TestComprehensiveIntegration:
    ...
    async def test_security_features(self):
        ...
        is_brute_force = await audit_logger.track_failed_attempt("192.168.1.100", "user456")
    ...
    async def test_compliance_features(self):
        ...
        data_subject = DataSubject(
            ...
            processing_purposes={DataProcessingPurpose.SERVICE_PROVISION, DataProcessingPurpose.ANALYTICS}
        )
