    ...
    def start_requests(self) -> Generator[scrapy.Request, None, None]:
        ...
        for url in urls:
            yield scrapy.Request(
                url=url,
                callback=self.parse,
                meta={'spider_info': {'name': 'linkedin-company-scraper', 'version': '1.2.0', 'author': 'DataHunters', 'description': 'Extract company information and employee data from LinkedIn profiles', 'category': 'business-intelligence', 'tags': ['linkedin', 'companies', 'employees', 'social'], 'requirements': ['selenium', 'beautifulsoup4'], 'entry_point': 'linkedin_scraper.CompanySpider', 'license': 'MIT', 'downloads': 1250, 'rating': 4.6, 'rating_count': 89, 'verified': True, 'installed': False, 'package_url': 'https://github.com/datahunters/linkedin-scraper/archive/v1.2.0.zip'}}
            )
