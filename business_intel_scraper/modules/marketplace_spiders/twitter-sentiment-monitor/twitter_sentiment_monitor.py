    ...
    def start_requests(self) -> Generator[scrapy.Request, None, None]:
        ...
        for url in urls:
            yield scrapy.Request(
                url=url,
                callback=self.parse,
                meta={'spider_info': {'name': 'twitter-sentiment-monitor', 'version': '1.5.3', 'author': 'SentimentLab', 'description': 'Monitor Twitter for brand mentions and sentiment analysis', 'category': 'social-media', 'tags': ['twitter', 'sentiment', 'monitoring', 'brand'], 'requirements': ['tweepy', 'textblob', 'pandas'], 'entry_point': 'twitter_monitor.SentimentSpider', 'license': 'GPL-3.0', 'downloads': 890, 'rating': 4.3, 'rating_count': 67, 'verified': False, 'installed': False, 'package_url': 'https://github.com/sentimentlab/twitter-monitor/archive/v1.5.3.zip'}}
            )
