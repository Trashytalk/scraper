...
class BusinessNewsSpider(scrapy.Spider):
    ...
    def parse(self, response: Response) -> Generator[Dict[str, Any], None, None]:
        ...
        try:
            ...
            article_links = response.css('a[data-testid="Heading"]::attr(href)').getall()
    ...
    def parse_article(self, response: Response) -> Generator[Dict[str, Any], None, None]:
    ...
    def _extract_companies(self, content: str) -> list:
        ...
        company_indicators = [
            ...
            'LLC', 'LP', 'Holdings', 'Group', 'Enterprises', 'Industries'
        ]
