...
def upgrade():
    ...
    op.create_index('idx_source_job', 'centralized_data', ['source_job_id', 'source_job_type'])
    op.create_index('idx_data_type_time', 'centralized_data', ['data_type', 'scraped_at'])
    op.create_index('idx_quality_time', 'centralized_data', ['data_quality_score', 'centralized_at'])
