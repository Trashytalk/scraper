...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_scrape_tasks_company_id'), 'scrape_tasks', ['company_id'], unique=False)
    op.create_index(op.f('ix_scrape_tasks_status'), 'scrape_tasks', ['status'], unique=False)
    op.create_index(op.f('ix_scrape_tasks_user_id'), 'scrape_tasks', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_osint_results_task_id'), 'osint_results', ['task_id'], unique=False)
