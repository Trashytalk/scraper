    ...
    async def test_network_data_no_filters(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                f"{BASE_URL}/network-data", json=payload, timeout=TEST_TIMEOUT
            )
...
class TestTimelineDataEndpoint:
    ...
    async def test_timeline_data_success(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                f"{BASE_URL}/timeline-data", json=payload, timeout=TEST_TIMEOUT
            )
    ...
    async def test_timeline_data_with_filters(self):
        ...
        payload = {"date_range": {"start": "2024-01-01", "end": "2024-12-31"}}
...
class TestGeospatialDataEndpoint:
    ...
    async def test_geospatial_data_success(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                f"{BASE_URL}/geospatial-data", json=payload, timeout=TEST_TIMEOUT
            )
...
class TestExportEndpoints:
    ...
    async def test_export_network_json(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{BASE_URL}/export/network?format=json", timeout=TEST_TIMEOUT
            )
    ...
    async def test_export_timeline_json(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{BASE_URL}/export/timeline?format=json", timeout=TEST_TIMEOUT
            )
    ...
    async def test_export_geospatial_json(self):
        ...
        async with httpx.AsyncClient() as client:
            response = await client.get(
                f"{BASE_URL}/export/geospatial?format=json", timeout=TEST_TIMEOUT
            )
    ...
    async def test_export_csv_format(self):
        ...
        for endpoint in endpoints:
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{BASE_URL}/export/{endpoint}?format=csv", timeout=TEST_TIMEOUT
                )
...
class TestErrorHandling:
    ...
    async def test_invalid_endpoints(self):
        ...
        for endpoint in invalid_endpoints:
            async with httpx.AsyncClient() as client:
                response = await client.get(
                    f"{BASE_URL}{endpoint}", timeout=TEST_TIMEOUT
                )
...
class TestPerformance:
    ...
    async def test_large_payload(self):
        ...
        payload = {"search_term": large_search_term, "confidence_threshold": 0.5}
