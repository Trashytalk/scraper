...
class TestDOMChangeDetection:
    ...
    @pytest.mark.asyncio
    async def test_dom_change_detection_basic(
        self, dom_detector, sample_html_v1, sample_html_v2
    ):
    ...
    @pytest.mark.asyncio
    async def test_element_addition_detection(
        self, dom_detector, sample_html_v1, sample_html_v2
    ):
    ...
    @pytest.mark.asyncio
    async def test_css_selector_change_detection(
        self, dom_detector, sample_html_v1, sample_html_v2
    ):
    ...
    @pytest.mark.asyncio
    async def test_change_severity_classification(
        self, dom_detector, sample_html_v1, sample_html_v2
    ):
        ...
        assert any(
            change.severity in ["low", "medium", "high", "critical"]
...
class TestSpiderUpdateSystem:
    ...
    @pytest.mark.asyncio
    async def test_spider_update_identification(
        self, spider_updater, dom_detector_with_changes
    ):
...
class TestPhase2Integration:
    ...
    async def test_end_to_end_change_detection_and_update(self):
        ...
        new_html = (
            "<div class='business-list'><div class='business'>ABC Corp</div></div>"
        )
