...
def test_browser_crawler_requires_dependency(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "business_intel_scraper.backend.modules.crawlers.browser.sync_playwright",
        None,
    )
    monkeypatch.setattr(
        "business_intel_scraper.backend.modules.crawlers.browser.webdriver",
        None,
    )
    monkeypatch.setattr(
        "business_intel_scraper.backend.modules.crawlers.browser.ChromeOptions",
        None,
    )
