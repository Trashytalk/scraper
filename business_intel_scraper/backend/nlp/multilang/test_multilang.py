...
from business_intel_scraper.backend.nlp.multilang.core import language_detector, ScriptType
from business_intel_scraper.backend.nlp.multilang.tokenization import multilang_tokenizer
...
from business_intel_scraper.backend.nlp.multilang.normalization import (
    phone_normalizer, address_normalizer, company_id_normalizer,
    financial_normalizer, date_normalizer
)
...
TEST_DATA = {
    'english': {
        ...
        'expected_entities': ['Apple Inc.', '1 Apple Park Way', 'Cupertino', '+1-408-996-1010']
    },
    'chinese': {
...
class TestLanguageDetection:
    ...
    def test_mixed_script_detection(self):
        ...
        script, confidence = language_detector.detect_script(TEST_DATA['mixed_script']['text'])
...
class TestTokenization:
    ...
    def test_fallback_tokenization(self):
        ...
        lang = language_detector.language_data['th']  # Thai - might not have specialized tokenizer
...
class TestNER:
    ...
    def test_business_pattern_extraction(self):
        ...
        company_entities = [e for e in entities if 'corp' in e.text.lower() or 'llc' in e.text.lower()]
        # Pattern-based detection may find these
        
        # Should detect EIN pattern
        ein_entities = [e for e in entities if 'EIN' in e.text or '12-3456789' in e.text]
...
class TestTransliteration:
    ...
    def test_universal_transliteration(self):
        ...
        result = script_transliterator.transliterate_universal(mixed_text, ScriptType.LATIN)
...
class TestEntityNormalization:
    ...
    def test_similarity_calculation(self):
        ...
        name1 = entity_normalizer.normalize_company_name("Apple Inc.", language_detector.language_data['en'])
        name2 = entity_normalizer.normalize_company_name("Apple Incorporated", language_detector.language_data['en'])
