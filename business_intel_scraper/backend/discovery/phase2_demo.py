...
class Phase2Demo:
    ...
    async def demo_dom_analysis(self):
        ...
        fingerprint = await self.analyzer.analyze_page("https://demo-ecommerce.com", demo_html)
    ...
    async def demo_change_detection(self):
        ...
        original_fp = await self.analyzer.analyze_page("https://demo-site.com", original_html)
        
        print("📊 Analyzing modified page structure...")
        modified_fp = await self.analyzer.analyze_page("https://demo-site.com", modified_html)
        
        print("🔍 Detecting changes...")
        changes = self.detector.compare_fingerprints("https://demo-site.com", original_fp, modified_fp)
        ...
        for change in changes:
            ...
            print(f"   {severity_icon.get(change.severity, '⚪')} [{change.severity.upper()}] {change.change_type}")
...
"""
        ...
        demo_changes = [
            type('DOMChange', (), {
                ...
                'auto_fixable': True,
                'suggested_fixes': ['Update CSS selector from "div.product" to "article.product-card"']
            })(),
            type('DOMChange', (), {
                'url': 'https://demo-site.com',
                ...
                'auto_fixable': True,
                'suggested_fixes': ['Update attribute selector from "data-id" to "data-product-id"']
            })(),
            type('DOMChange', (), {
                'url': 'https://demo-site.com',
                ...
                'auto_fixable': True,
                'suggested_fixes': ['Update CSS selector from "span.price" to "span.price-display"']
            })()
        ]
        ...
        print(f"🔧 Applying automatic spider updates...")
