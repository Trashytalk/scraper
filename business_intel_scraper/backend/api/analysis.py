...
from ..analysis.orchestrator import AnalysisRequest, AnalysisResult
...
class AnalysisRequestModel(BaseModel):
    ...
    include_low_confidence: bool = Field(
        default=False,
        description="Include low confidence results"
    )
    ...
    def validate_analysis_types(cls, v):
        valid_types = {'entity_resolution', 'relationship_mapping', 'enrichment', 'event_detection'}
    ...
    def validate_enrichment_sources(cls, v):
        valid_sources = {'sanctions', 'contracts', 'patents', 'social', 'financial', 'news'}
        for source in v:
...
async def resolve_entities(
    ...
    try:
        ...
        response_data = {
            ...
            'duplicate_ratio': 1.0 - (len(entity_clusters) / len(entities)) if entities else 0.0
        }
...
async def map_relationships(
    ...
    try:
        ...
        response_data = {
            ...
            'relationship_types': list(set(rel['relationship_type'] for rel in relationship_data))
        }
    ...
    try:
        ...
        return JSONResponse(content={
            ...
            'data': {
                ...
                'sources_used': list(set(e['source_name'] for e in enrichment_data))
            }
        })
    ...
    try:
        ...
        return JSONResponse(content={
            ...
            'data': {
                ...
                'high_priority_events': len([e for e in event_data if e['severity'] in ['high', 'critical']])
            }
        })
...
async def clear_analysis_cache(
    ...
    try:
        ...
        return JSONResponse(content={
            'success': True,
            'message': 'Analysis caches cleared successfully'
        })
