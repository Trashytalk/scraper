...
class SecurityConfig:
    ...
    def validate_jwt_secret(cls) -> bool:
        ...
        if len(cls.JWT_SECRET) < 32:
            print("⚠️  WARNING: JWT secret is less than 32 characters. Consider using a stronger secret.")
            return False
        if cls.JWT_SECRET == "your-super-secret-jwt-key-change-this-in-production-min-32-chars":
...
class DatabaseConfig:
    ...
    DATABASE_PATH: str = os.getenv("DATABASE_PATH", "/home/homebrew/scraper/data/scraper.db")
