...
class TestDataIngestionWorkflow:
    ...
    def test_complete_article_processing_workflow(self, integration_repository, sample_scraping_data):
    ...
    def test_multi_source_data_aggregation(self, integration_repository, sample_scraping_data):
...
class TestAlertManagementIntegration:
    ...
    def test_alert_lifecycle_management(self, integration_repository):
        ...
        critical_alerts = integration_repository.get_active_alerts(severity_filter='critical')
...
class TestCrossComponentIntegration:
    ...
    def test_repository_model_integration(self, integration_repository, sample_scraping_data):
        ...
        analytics = integration_repository.create_analytics_snapshot('daily', datetime.utcnow())
