        ...
        try:
            ...
            if isinstance(data, dict) and "summary" in data:
                ...
                if actual_pages >= expected_min_pages and actual_pages > 1:
                    print(
                        f"✅ SUCCESS: Crawled {actual_pages} pages (expected >= {expected_min_pages})"
                    )
                    ...
                    print(
                        f"❌ FAILED: Only crawled {actual_pages} pages, expected at least {expected_min_pages}"
                    )
                ...
                if job_status:
                    ...
                    if results_count == actual_pages:
                        ...
                        print(
                            f"⚠️  Database results count ({results_count}) != crawled data ({actual_pages})"
                        )
