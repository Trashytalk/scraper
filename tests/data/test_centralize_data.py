...
def test_centralize_data():
    ...
    sample_data = [
        ...
        },
        {
            ...
            "images": [
                {"src": "https://example.com/product.jpg", "alt": "Product Image"}
            ],
        ...
        },
        {
            ...
            "links": [
                {"url": "https://news.example.com/related", "text": "Related News"}
            ],
            "images": [
                {"src": "https://news.example.com/headline.jpg", "alt": "News Image"}
            ],
